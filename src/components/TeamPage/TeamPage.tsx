            ...
            <div key={index} className="bg-white shadow-lg rounded-lg overflow-hidden">
              ...
              >
                ...
                <img
                  ...
                  alt="Original"
                  className={`w-full h-full transition duration-500 ease-in-out ${isHovered ? 'opacity-0' : 'opacity-100'}`}
                />
                ...
                <img
                  ...
                  alt="Pixelated"
                  className={`w-full h-full absolute top-0 left-0 transition duration-500 ease-in-out ${isHovered ? 'opacity-100 glitch-effect' : 'opacity-0'}`}
                />
              </div>
              <div className="p-4">
